...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PuntoRecoleccion.findAll", query = "SELECT p FROM PuntoRecoleccion p GROUP BY p.nombreMunicipalidad.nombreMunicipalidad ORDER BY p.idPunto DESC "),
